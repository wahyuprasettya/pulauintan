        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Laporan Data Tutor</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <?php
                include 'fungsi/koneksi.php';
                $query = mysqli_query($koneksi,'select *from tbl_tutor');
                ...
                <tr>
                    ...
                    <a href="fungsi/hapus_tutor.php?id='.$data['id_tutor'].'" class="btn btn-xs btn-danger"><i class="fa fa-trash"> </i>Hapus</a>
                    <td>
                  </tr>
                  ';
                  }
