          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <?php
                include 'fungsi/koneksi.php';
                $query = mysqli_query($koneksi,'SELECT tbl_materi.nama_materi, tbl_tutor.nama_lengkap, tbl_ruang.nama_ruang FROM tbl_jadwal JOIN tbl_materi ON tbl_jadwal.id_materi = tbl_materi.id_materi JOIN tbl_tutor ON tbl_jadwal.id_tutor = tbl_tutor.id_tutor JOIN tbl_ruang ON tbl_jadwal.id_ruang = tbl_ruang.id_ruang');
