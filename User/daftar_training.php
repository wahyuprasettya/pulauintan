      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <h3 class="box-title">Pengambilan program</h3>
            ...
            <div class="box-body">
              ...
              // $query1 = mysqli_query($koneksi,'SELECT tbl_materi.nama_materi, tbl_ruang.nama_ruang ,tbl_ruang.kapasitas FROM tbl_rancang_program JOIN tbl_materi ON tbl_rancang_program.id_materi = tbl_materi.id_materi JOIN tbl_ruang ON tbl_rancang_program.id_ruang = tbl_ruang.id_ruang');
              // $data1 = mysqli_fetch_array($query1);  
              $query= mysqli_query($koneksi,'select * from tbl_materi'); 
                ...
                <tr>
                  ...
                  <td>
                  <form method ="post">
                  <input type="checkbox" name="vehicle" value="'.$data['id_materi'].'">
                  </form>
                  </td>    
