    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <div class="pull-left info">
          <p><?php echo $_SESSION = $data['username']; ?></p>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="daftar_program.php"><i class="fa fa-circle-o"></i>Tambah program</a></li>
        ...
        <li class="treeview">
            ...
            <li><a href="exit.php"><i class="fa fa-sign-out" name = "logout"></i> <span>Keluar</span></a></li>
    </section>
    <!-- /.sidebar -->
  </aside>
  <!-- =============================================== -->
