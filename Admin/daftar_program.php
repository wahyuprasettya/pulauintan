    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Pendaftaran program</h3>
        ...
        <div class="box-body">
          <form role="form" method = "post" action ="fungsi/tambah_program.php">
            <div class="box-body">
              <div class="form-group">
              <label for="">Nama program</label>
                <input type="text" class="form-control" id="" placeholder="" name ="program">
              </div>
