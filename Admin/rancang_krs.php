  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <div class="box-body">
          <form role="form" method = "post" action ="fungsi/tambah_user.php">
            <div class="box-body">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="" placeholder="" name ="periode">
              </div>
              <div class="form-group">
                <label for="">tgl_masuk</label>
                <input type="text" class="form-control" id="" placeholder="" name ="tgl">
              </div>
              <div class="form-group">
                <label for="">Proyek</label>
                <input type="text" class="form-control" id="" placeholder="" name="proyek">
              </div>
              <div class="form-group">
                <label for="">No telp</label>
                <input type="text" class="form-control" id="" placeholder="" name="no_telp">
              </div>
              <div class="form-group">
                <label>Alamat</label>
